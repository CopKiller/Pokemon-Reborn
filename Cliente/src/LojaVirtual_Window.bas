...
Public Function ResetState_VirtualShopSlot()
    ...
    '//Verificar se está ingame
    If Not GameState = GameStateEnum.InGame Then Exit Function
    
    '//Verificar se está com o VirtualShop Open
    If Not GUI(GuiEnum.GUI_VIRTUALSHOP).Visible Then Exit Function
    
    '//Verificar se o VirtualShop possui uma MATRIZ
    If Not GetIndexFromVirtualShop > 0 Then Exit Function
