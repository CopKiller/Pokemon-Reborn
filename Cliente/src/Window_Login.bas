...
Public Sub DrawLogin()
    ...
    With GUI(GuiEnum.GUI_LOGIN)
        ...
        ' Dar as boas vindas com uma mensagem no topo da janela de login
        Select Case tmpCurLanguage
        Case LANG_PT: SString = "Bem Vindo ao Pokémon Reborn!"
        Case LANG_EN: SString = "Welcome To Poke Reborn!"
        Case LANG_ES: SString = "Welcome To Poke Reborn!"
        End Select
