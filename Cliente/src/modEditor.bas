...
Public Sub ItemEditorLoadIndex(ByVal xIndex As Long)
    ...
    With frmEditor_Item
        ...
        If Item(xIndex).Type = ItemTypeEnum.Vip Then
            .fraVip.Visible = True
            .chkVipType(Item(xIndex).Data1).value = True
            .txtVipDays.Text = Item(xIndex).Data2
        Else
...
Dim i As Long
    ...
    With frmEditor_Spawn
        ...
        .chkUniqueEnemy = Spawn(xIndex).UniqueEnemy
